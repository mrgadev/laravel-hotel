        ...
        <div class="container mx-auto">
            <div class="flex flex-col gap-5 w-full p-6">
                <div class="flex items-center gap-1 bg-primary-100 p-2 text-primary-700 rounded-lg w-fit text-sm">
                    ...
                    <a href="{{route('dashboard.nearby-location.index')}}" class="flex items-center hover:underline">
                        <p>Lokasi Terdekat</p>
                    </a>
                    <span class="material-symbols-rounded">chevron_right</span>
                    <p>Buat Baru</p>
        ...
        <section class="container px-6 mx-auto">
            <main class="col-span-12 md:pt-0">
                <div class="p-2 mt-2 bg-white rounded-xl shadow-lg">
                    <form action="{{route('dashboard.nearby-location.store')}}" method="POST" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="">
                                ...
                                <div class="mt-10">
                                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 items-center">
                                        <div>
                                            ...
                                            <input placeholder="Nama Lokasi Terdekat" type="text" name="name" id="name" autocomplete="off" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
                                        ...
                                        <div>
                                            ...
                                            <input placeholder="Jarak Lokasi Terdekat" type="number" name="distance" id="distance" autocomplete="off" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
                                            @error('distance')
