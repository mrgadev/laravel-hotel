        ...
        <div class="container mx-auto">
            <div class="flex flex-col gap-5 w-full p-6">
                <div class="flex items-center gap-1 bg-primary-100 p-2 text-primary-700 rounded-lg w-fit text-sm">
                    ...
                    <a href="{{route('dashboard.accomodation-plan.index')}}" class="flex items-center hover:underline">
            ...
            <section class="container px-6 mx-auto">
                <main class="col-span-12 md:pt-0">
                    <div class="px-2 py-2 mt-10 bg-white rounded-xl shadow-lg">
                        <form action="{{route('dashboard.accomodation-plan.store')}}" method="POST" enctype="multipart/form-data">
                            @method('POST')
                            @csrf
                            <div class="">
                                    ...
                                    <div class="mt-10">
                                        <div class="grid grid-cols-6 gap-6">
                                            <div class="md:col-span-6 lg:col-span-3">
                                                ...
                                                <input placeholder="Nama Rencana" type="text" name="name" id="password" autocomplete="off" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
