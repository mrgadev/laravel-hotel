                                ...
                                <div class="mt-10">
                                    <div class="grid grid-cols-1 gap-4 items-center">
                                        <div>
                                            ...
                                            <input placeholder="Pertanyaan" type="text" name="question" id="question" autocomplete="off" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
                                        ...
                                        <div>
                                            <label for="faqAnswer" class="block mb-3 font-medium text-gray-700 text-md">Jawaban</label>
                                            <textarea name="answer" class="block border  w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm" id="faqAnswer" cols="30" rows="10"></textarea>
